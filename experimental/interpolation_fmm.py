"""Interpolation FMM preserved from main commit a051f13 for comparisons.

This independent reference engine requires NumPy; production uses gravity_sim.py.
Its unmodified API is solver_mode, fmm_order, fmm_leaf_capacity, fmm_max_level.
"""
